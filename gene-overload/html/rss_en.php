...
//    session_start();
  ...
  for ($i = 1; $i <= $cuantas; $i++)
  {
      ...
      $link = "http://www.geneoverload.com/index.php?lang=en&amp;catid=53&amp;idcampana=&amp;idelemento=".$array[$i]['id']."&amp;accion=comentar";
      // Tenemos que fabricar el $link

                echo "
                        <item>
                        <title>".$array[$i]['titular_en']."</title>
                        <link>".$link."</link>
";
                ...
                echo ("<description>".htmlentities(stripslashes($array[$i]['texto_en']))."</description>
");

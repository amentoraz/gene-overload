...
//    $jugador_campana->SumarTodos($link_w, $idcampana, $dinero, 15);
    $jugador_campana->SumarTodos($link_w, $idcampana, $dinero);

    // Enviamos el informe de que ha llegado una subvencion con esa cantidad de pasta
    $informe->EnviarSubvencionEspecial($link_w, $idcampana, $dinero);
...
//print_r ($array);
    ?>
    <form method="post" action="dinero_especial.php">
